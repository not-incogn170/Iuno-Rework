...
async function main(){
  ...
  sock.ev.on('messages.upsert', async ({messages}) => {
    ...
    const rawText = msg.message.conversation || msg.message.extendedTextMessage?.text || msg.message.imageMessage?.caption || msg.message.videoMessage?.caption || msg.message.extendedTextMessage?.contextMessage || "<not yet implemented>"
    ...
    switch(text[0]){
      ...
      case '.s':
        ...
        }else if(msg.message.imageMessage && msg.message.extendedTextMessage?.contextInfo?.quotedMessage?.imageMessage){
